...
Given the conversation, output a single search that:
 - Captures the topic and intent of latest user message.
 - Resolves pronous and references using prior turns ("it", "they", "that one").
 ...
 Output only the query. No preamble, no quotes, no explanations
`
