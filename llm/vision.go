...
const captionPrompt = "Describe this image in 2-3 sentences for a search index. Foccus on the visible subject- what it is, key details, style. Do not interpret or speculate; describe only what is shown"
